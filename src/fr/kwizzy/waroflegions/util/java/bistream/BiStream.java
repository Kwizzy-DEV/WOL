...
public interface BiStream<T , U> extends BaseStream<BiStream.BiValue<T , U> , BiStream<T , U>>{
     ...
     * @param <T> The First value of BiStream
     * @param <U> The Second value of BiStream
     */
    class BiValue<T , U>{
        /**
     ...
     * Using an unordered stream source (such as {@link #wrap(Stream)})
     ...
     * stream source (such as {@link #wrap(Stream)}) or removing the
     ...
     * }</pre>
     *
     * <p>Like {@link #reduce(BiValue, BinaryOperator)}, {@code collect} operations
