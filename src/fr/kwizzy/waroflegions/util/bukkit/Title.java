...
public class Title {
		...
		if (Title.packetTitle != null) {
			try {
				...
				Object packet = Title.packetTitle
						.getConstructor(new Class[]{Title.packetActions, chatBaseComponent, Integer.TYPE, Integer.TYPE,
								Integer.TYPE})
						.newInstance(
								new Object[]{actions[2], null, Integer.valueOf(this.fadeInTime * (this.ticks ? 1 : 20)),
    ...
    public static void broadcastTitle(String title, String subtitle){
        new Title(title, subtitle).broadcast();
    }

    public static void broadcastTitle(String title, String subtitle, int fadeInTime, int time, int fadeOutTime){
        new Title(title, subtitle, fadeInTime, time, fadeOutTime).broadcast();
    }
    ...
    public static void sendTitle(String title, String subtitle, int fadeInTime, int time, int fadeOutTime, Player... p){
        for (Player player : p) {
            new Title(title, subtitle, fadeInTime, time, fadeOutTime).send(player);
        }
    }
