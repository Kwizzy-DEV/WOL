...
public class ActionBar {
	...
	static {
		try {
			chatSer = Reflection.getConstructor(Class.forName("net.minecraft.server." + BV + ".ChatComponentText"),
					String.class);

			packetChat = Class.forName("net.minecraft.server." + BV + ".PacketPlayOutChat")
					.getConstructor(Class.forName("net.minecraft.server." + BV + ".IChatBaseComponent"), byte.class);
			getPlayerHandle = Class.forName("org.bukkit.craftbukkit." + BV + ".entity.CraftPlayer")
					.getDeclaredMethod("getHandle");
			playerConnection = Class.forName("net.minecraft.server." + BV + ".EntityPlayer")
					.getDeclaredField("playerConnection");
			sendPacket = Class.forName("net.minecraft.server." + BV + ".PlayerConnection")
	...
	/**
	 * This method checks if the ActionBar has been initialised properly
	 * 
